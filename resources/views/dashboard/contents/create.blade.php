    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-form">Create new content</h4>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" class="form-control" name="lecture" value="{{ old('lecture') }}" placeholder="Enter lecture nuber">
                                                        <p class="text-danger">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="content_title" value="{{ old('content_title') }}" placeholder="Enter content title">
                                                        <p class="text-danger">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea readonly class="form-control" name="video_embed" id="embed" cols="30" rows="2">{{ old('video_embed') }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="editor" rows="20" class="form-control" name="content_description" placeholder="Course description">{{ old('content_description') }}</textarea>
                                                <p class="text-danger">
