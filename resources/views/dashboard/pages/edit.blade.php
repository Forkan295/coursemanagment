    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="basic-layout-form">Update page</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="page_title" value="{{ old('page_title', $page->page_title) }}" placeholder="Enter page title">
                                                <p class="text-danger">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="page_slug" value="{{ old('page_slug', $page->page_slug) }}" placeholder="Enter page slug">
                                                <p class="text-danger">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="editor" rows="20" class="form-control" name="page_description" placeholder="page description">{!! old('page_description',$page->page_description) !!}</textarea>
                                                <p class="text-danger">
                                            ...
                                            <div id="meta-options" style="display:none">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="meta_keyword" value="{{ old('meta_keyword', $page->meta_keyword) }}" placeholder="Enter meta keyword">
                                                    <p class="text-danger">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="editor" rows="10" class="form-control" name="meta_description" placeholder="Meta description">{{ old('meta_description', $page->meta_description) }}</textarea>
                                                    <p class="text-danger">
                                        ...
                                        <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="course-change" name="page_status" class="form-control" >
                                                        <option
                                                        {{ ($page->page_status == true) ? "selected" : "" }}
                                                        value="1">Active</option>
                                                        <option
                                                        {{ ($page->page_status == false) ? "selected" : "" }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" type="select" name="show_main_menu" id="">
                                                         <option
                                                         {{ ($page->show_main_menu == true) ? "selected" : "" }}
                                                         value="1">yes</option>  
                                                         <option
                                                         {{ ($page->show_main_menu == false) ? "selected" : "" }}
                                                         value="0">No</option>  
                                                    </select>
                                                    <p class="text-danger">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" type="select" name="show_footer" id="">
                                                         <option 
                                                         {{ ($page->show_footer == true) ? "selected" : "" }}
                                                         value="1">yes</option>  
                                                         <option 
                                                         {{ ($page->show_footer == false) ? "selected" : "" }}
                                                         value="0">No</option>  
                                                    </select>
                                                    <p class="text-danger">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img width="200px" src="{{ url('storage/page', $page->featured_image ) }}">
                                                     <br> <br> 
